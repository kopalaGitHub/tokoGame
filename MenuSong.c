...
static const unsigned char* const order1[] = {P0,P13,P12};
static const unsigned char* const order2[] = {P1,P5,P9};
static const unsigned char* const order3[] = {P2,P2,P2};
static const unsigned char* const order4[] = {P2,P2,P11};
...
static const unsigned char waves[] = {
    ...
    115,186,33,211,125,170,73,152,35,75,196,19,122,27,42,216,
    0,4,93,112,124,185,186,10,150,201,144,229,6,7,110,72,
    201,219,121,138,76,123,30,156,33,28,142,132,1,147,232,238,
    102,228,160,238,54,57,149,209,25,45,137,103,93,132,83,98,
    113,174,208,183,237,69,59,134,156,145,14,161,69,92,102,57,
};

const hUGESong_t menu_song = {7, &order_cnt, order1, order2, order3,order4, duty_instruments, wave_instruments, noise_instruments, NULL, waves};
